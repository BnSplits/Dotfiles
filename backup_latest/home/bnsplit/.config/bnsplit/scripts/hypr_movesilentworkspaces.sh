...
handle_next() {
  ...
  hyprctl dispatch movetoworkspacesilent "$next_id"
}
...
handle_previous() {
  ...
  hyprctl dispatch movetoworkspacesilent "$prev_id"
}
...
handle_last() {
  ...
  hyprctl dispatch movetoworkspacesilent "$last_id"
}
...
handle_first() {
  ...
  hyprctl dispatch movetoworkspacesilent "$first_id"
}
...
handle_numeric() {
  ...
  hyprctl dispatch movetoworkspacesilent "$target_id"
}
